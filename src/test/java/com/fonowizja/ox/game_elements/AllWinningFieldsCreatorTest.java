...
public class AllWinningFieldsCreatorTest
{
   ...
   public Object[][] getIntegerStreams()
   {
      return new Object[][] {
            { Arrays.asList(Arrays.asList(0, 1, 2), Arrays.asList(1, 2, 3), Arrays.asList(2, 3, 4), Arrays.asList(3, 4, 5),
                  ...
                  Arrays.asList(14, 15, 16), Arrays.asList(15, 16, 17), Arrays.asList(16, 17, 18), Arrays.asList(17, 18, 19),
                  Arrays.asList(18, 19, 20),
                  Arrays.asList(2, 8, 14), Arrays.asList(3, 9, 15), Arrays.asList(4, 10, 16), Arrays.asList(5, 11, 17), Arrays.asList(6, 12, 18),
                  Arrays.asList(4, 12, 20), Arrays.asList(3, 11, 19), Arrays.asList(2, 10, 18), Arrays.asList(1, 9, 17), Arrays.asList(0, 8, 16))
            }
   ...
   public void testCreateAllWinningFields(List<List<Integer>> expect)
   {
